...
try {
    $estadoRecibido = "Rembolsado"; // Cambia esto al estado deseado
        ...
        <div class="pedidos-container">
            <?php foreach ($pedidosRecibidos as $pedido) : ?>
                <div class="pedido-card animate__animated  animate__fadeIn animate__faster">
                    <h2>Nombre: <?php echo $pedido['nombre']; ?></h2>

                    <p>Fecha de Pedido: <?php echo $pedido['fecha_pedido']; ?></p>
                    <p>Estado: <?php echo $pedido['estado']; ?></p>
                    <p>Pagado: <?php echo $pedido['pagado']; ?></p>
                    <p>Pedido:</p>
                    <?php
                    ...
                    ?>
                    <p>Observación: <?php echo $pedido['observacion']; ?></p>
