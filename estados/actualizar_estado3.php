...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["enviar_entregados"]) && isset($_POST["pedido_id"])) {
    ...
    try {
        ...
        if ($stmt->execute()) {
            header("Location: entregados.php"); // Redirige de nuevo a la página de pedidos recibidos
            exit();
        } else {
