...
try {
    $estadoRecibido = "In Process"; // Cambia esto al estado deseado
            ...
            <?php foreach ($pedidosRecibidos as $pedido) : ?>
                <div class="pedido-card animate__animated  animate__fadeIn animate__faster	">
                    ...
                    <div class="datos_cliente ocultar">
                        ...
                        <p>Phone: <?php echo $pedido['telefono_cliente']; ?></p>
                    </div>
                    ...
                    ?>
                        <div class="pedido-item">
                            <label class="custom-checkbox-label">
                                <input type="checkbox" class="custom-checkbox" name="preparado[]" value="<?php echo $item['nombre']; ?>">
                    ...
                    <form action="actualizar_estado3.php" method="POST">
                        <input type="hidden" name="pedido_id" value="<?php echo $pedido['id']; ?>">
                        <button type="submit" name="enviar_entregados">Send to Delivered</button>
                    </form>
