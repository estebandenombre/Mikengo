...
try {
    $estadoRecibido = "Completed"; // Cambia esto al estado deseado
        ...
        <div class="pedidos-container animate__animated  animate__fadeIn animate__faster">
            <?php foreach ($pedidosRecibidos as $pedido) : ?>
                <div class="pedido-card">
                    ...
                    <form action="actualizar_rembolso.php" method="POST">
                        <input type="hidden" name="pedido_id" value="<?php echo $pedido['id']; ?>">
                        <button type="submit" name="enviar_rembolso">Refund</button>
                    </form>
                </div>
            <?php endforeach; ?>
        </div>
